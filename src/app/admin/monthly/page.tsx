...
function getThaiMonthName(monthStr: string) {
...
export default function MonthlyPage() {
  ...
  function exportCSV() {
    const headers = ["วันที่", "ทะเบียน", "ชื่อ", "เบอร์", "เวลาเริ่ม", "เวลาสิ้นสุด", "ชั้นจอด", "ไมล์ขาไป", "ไมล์ขากลับ", "ระยะ (กม.)", "สถานะ"];
  ...
  return (
    <AdminLayout>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div>
          <h2 className="text-h1 font-semibold text-forest-green">สรุปรายเดือน</h2>
          <p className="text-caption text-neutral-gray mt-0.5">
            {selectedMonth ? getThaiMonthName(selectedMonth) : ""}
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="card text-center py-16">
          ...
          <p className="text-body text-neutral-gray">ไม่มีข้อมูลการจองในเดือนนี้</p>
        </div>
      ) : (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <KpiCard
              ...
              unit="ครั้ง"
              sub={totalPending > 0 ? `รอดำเนินการ ${totalPending}` : ""}
              color="text-red-500"
              bg="bg-red-50"
          ...
          <div className="bg-white rounded-2xl border border-neutral-gray/40 p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-body font-semibold">ค่าทางด่วนประจำเดือน</h3>
            </div>
              ...
              {tollAmount > 0 && (
                <div className="flex gap-4 pb-1">
                  <div className="text-center">
                    <p className="text-caption text-neutral-gray">รวมค่าทางด่วน</p>
                    <p className="text-h2 font-dm-sans font-semibold text-desert-brown">
                      {tollAmount.toLocaleString()} <span className="text-caption font-normal">บาท</span>
                    </p>
                  </div>
                  {totalMileage > 0 && (
                    <div className="text-center">
                      <p className="text-caption text-neutral-gray">เฉลี่ยต่อ กม.</p>
                      <p className="text-h2 font-dm-sans font-semibold text-desert-brown">
                        {(tollAmount / totalMileage).toFixed(2)} <span className="text-caption font-normal">บาท</span>
                      </p>
                    </div>
                  )}
                  {bookings.length > 0 && (
                    <div className="text-center">
                      <p className="text-caption text-neutral-gray">เฉลี่ยต่อเที่ยว</p>
                      <p className="text-h2 font-dm-sans font-semibold text-desert-brown">
                        {(tollAmount / totalReturned || 0).toFixed(0)} <span className="text-caption font-normal">บาท</span>
                      </p>
                    </div>
                  )}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="card">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-body font-semibold">การใช้งานแยกตามรถ</h3>
              </div>
                  ...
                  <div key={v.vehicle_id} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-caption text-neutral-gray font-dm-sans">{v.total_mileage.toLocaleString()} กม.</span>
                      </div>
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        <span className="text-caption text-neutral-gray">{v.total} ครั้ง</span>
                        <span className="text-caption text-blue-500">{v.returned} คืนแล้ว</span>
                        {v.cancelled > 0 && <span className="text-caption text-red-400">{v.cancelled} ยกเลิก</span>}
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="space-y-4">
              ...
              <div className="card">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-body font-semibold">ผู้ใช้รถบ่อยที่สุด</h3>
                </div>
                  ...
                  {userStats.slice(0, 5).map((u, i) => (
                    <div key={u.phone} className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-caption text-neutral-gray">ครั้ง</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {busiestDays.length > 0 && (
                <div className="card">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-body font-semibold">วันที่มีการจองมากสุด</h3>
                  </div>
          ...
          {/* ===== Completion ring ===== */}
          <div className="card">
            <h3 className="text-body font-semibold mb-4">สัดส่วนสถานะการจอง</h3>
            <div className="flex flex-wrap gap-6 items-center">
              ...
              <div className="relative w-28 h-28 flex-shrink-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <p className="text-caption text-neutral-gray leading-tight">สำเร็จ</p>
                </div>
              </div>
          ...
          <div className="card overflow-x-auto">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-body font-semibold">รายการจองทั้งหมด ({bookings.length} รายการ)</h3>
              <span className="text-caption text-neutral-gray">{getThaiMonthName(selectedMonth)}</span>
            </div>
            <table className="w-full text-caption">
              <thead>
                <tr className="border-b border-neutral-gray">
                  <Th>วันที่</Th><Th>ทะเบียน</Th><Th>ชื่อ</Th><Th>เวลา</Th>
                  <Th>ไมล์ (กม.)</Th><Th>สถานะ</Th>
                </tr>
              </thead>
              <tbody>
            ...
            {bookings.length > 8 && (
              ...
              >
                {showAllBookings ? "แสดงน้อยลง ↑" : `แสดงทั้งหมด ${bookings.length} รายการ ↓`}
              </button>
            )}
          </div>
          ...
          {tollAmount > 0 && (
            <div className="bg-white rounded-2xl border border-desert-brown/30 p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-body font-semibold">สรุปค่าทางด่วน</h3>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="text-center p-3 bg-desert-brown/5 rounded-xl">
                  <p className="text-caption text-neutral-gray mb-1">ค่าทางด่วนรวม</p>
                  <p className="text-h1 font-dm-sans font-semibold text-desert-brown">{tollAmount.toLocaleString()}</p>
                  <p className="text-caption text-neutral-gray">บาท</p>
                </div>
                <div className="text-center p-3 bg-desert-brown/5 rounded-xl">
                  <p className="text-caption text-neutral-gray mb-1">เฉลี่ยต่อเที่ยว</p>
                  <p className="text-h1 font-dm-sans font-semibold text-desert-brown">
                    {totalReturned > 0 ? (tollAmount / totalReturned).toFixed(0) : "—"}
                  </p>
                  <p className="text-caption text-neutral-gray">บาท/เที่ยว</p>
                </div>
                <div className="text-center p-3 bg-desert-brown/5 rounded-xl">
                  <p className="text-caption text-neutral-gray mb-1">เฉลี่ยต่อ กม.</p>
                  <p className="text-h1 font-dm-sans font-semibold text-desert-brown">
                    {totalMileage > 0 ? (tollAmount / totalMileage).toFixed(2) : "—"}
                  </p>
                  <p className="text-caption text-neutral-gray">บาท/กม.</p>
                </div>
                <div className="text-center p-3 bg-desert-brown/5 rounded-xl">
                  <p className="text-caption text-neutral-gray mb-1">เฉลี่ยต่อวัน</p>
                  <p className="text-h1 font-dm-sans font-semibold text-desert-brown">
                    {(tollAmount / 30).toFixed(0)}
                  </p>
                  <p className="text-caption text-neutral-gray">บาท/วัน</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="card bg-forest-green/5 border-forest-green/20">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-body font-semibold text-forest-green">ข้อเสนอแนะจากข้อมูลเดือนนี้</h3>
            </div>
            <div className="space-y-2.5">
              {recommendations(bookings, vehicleStats, userStats, tollAmount).map((r, i) => (
...
function recommendations(bookings: Booking[], vehicleStats: VehicleStat[], userStats: UserStat[], tollAmount = 0) {
  ...
  if (rate >= 80) recs.push({ type: "good", text: `อัตราการคืนรถสำเร็จ ${Math.round(rate)}% — ดีมาก ผู้ใช้งานให้ความร่วมมือดี` });
  else if (rate < 60) recs.push({ type: "warning", text: `อัตราการคืนรถสำเร็จต่ำ (${Math.round(rate)}%) — ควรติดตามการจองที่ค้างอยู่` });

  const cancelled = bookings.filter((b) => b.status === "cancelled").length;
  if (cancelled > 3) recs.push({ type: "warning", text: `มีการยกเลิก ${cancelled} ครั้ง — ควรสำรวจสาเหตุและปรับนโยบายการจอง` });
  ...
  if (topVehicle && vehicleStats.length > 1) {
    ...
    if (topVehicle.total_mileage > lastVehicle.total_mileage * 3) {
      recs.push({ type: "warning", text: `รถ ${topVehicle.license_plate} ถูกใช้งานมากกว่ารถอื่นๆ มาก — ควรกระจายการใช้งานให้สม่ำเสมอ` });
    }
  }

  if (topVehicle && topVehicle.total_mileage > 500) {
    recs.push({ type: "info", text: `รถ ${topVehicle.license_plate} วิ่ง ${topVehicle.total_mileage.toLocaleString()} กม. ในเดือนนี้ — ควรตรวจสอบการบำรุงรักษาตามระยะ` });
  }

  if (userStats.length > 0 && userStats[0].count >= 5) {
    recs.push({ type: "info", text: `${userStats[0].name} จองรถบ่อยที่สุด ${userStats[0].count} ครั้ง — อาจพิจารณาจัดรถประจำตัวให้` });
  }

  if (tollAmount > 0 && returned > 0) {
    const perTrip = (tollAmount / returned).toFixed(0);
    recs.push({ type: "info", text: `ค่าทางด่วนเฉลี่ย ${perTrip} บาท/เที่ยว — รวมทั้งเดือน ${tollAmount.toLocaleString()} บาท` });
  }

  if (bookings.length >= 25) recs.push({ type: "good", text: `เดือนนี้มีการจองรวม ${bookings.length} ครั้ง — ระบบถูกใช้งานสูง` });
  else if (bookings.length < 10) recs.push({ type: "info", text: "การจองน้อย — ลองประชาสัมพันธ์ระบบให้ทีมรับรู้มากขึ้น" });

  if (recs.length === 0) recs.push({ type: "info", text: "ข้อมูลปกติ ไม่พบความผิดปกติในเดือนนี้" });
  return recs;
}
