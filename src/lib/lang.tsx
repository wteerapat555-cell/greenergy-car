...
export const T = {
  ...
  return: {
    th: {
      ...
      mileOutAuto: "ดึงจากการคืนรถครั้งก่อน:", mileOutNoHistory: "ไม่มีประวัติ — กรอกเอง",
      labelMileIn: "เลขไมล์ขากลับ", placeholderMileIn: "ต้องมากกว่าขาไป",
      mileUsed: "ระยะทางที่ใช้", mileUnit: "กม.",
      labelFuel: "ระดับน้ำมัน (%)", placeholderFuel: "0–100",
      fuelHint: "บันทึกระดับน้ำมันเมื่อคืนรถ",
      labelWashed: "วันที่ล้างรถล่าสุด (ไม่บังคับ)", washedToday: "ล้างวันนี้",
      washedHint: "ข้อมูลจะแสดงในหน้าสถานะรถและแดชบอร์ด",
      labelParking: "ชั้นที่จอดรถ", placeholderParking: "เช่น ชั้น B1, ชั้น 2",
      labelImage: "ภาพรถ (ไม่บังคับ)",
    ...
    en: {
      ...
      mileOutAuto: "Auto-filled from last return:", mileOutNoHistory: "No history — enter manually",
      labelMileIn: "Return Mileage", placeholderMileIn: "Must be greater than outbound",
      mileUsed: "Distance used", mileUnit: "km",
      labelFuel: "Fuel Level (%)", placeholderFuel: "0–100",
      fuelHint: "Record fuel level on return",
      labelWashed: "Last Car Wash Date (optional)", washedToday: "Washed today",
      washedHint: "Shown on Fleet Status page and dashboard",
      labelParking: "Parking Floor", placeholderParking: "e.g. B1, Floor 2",
      labelImage: "Vehicle Photo (optional)",
  ...
  adminLayout: {
    th: {
      ...
      navDashboard: "แดชบอร์ด", navVehicles: "จัดการรถ", navReport: "รายงาน",
    ...
    en: {
      brand: "Greenergy Admin",
      navDashboard: "Dashboard", navVehicles: "Vehicles", navReport: "Reports",
